![Coin-Logo](https://github.com/hostmaria/mariacoin/blob/main/share/pixmaps/maria32.png)
# MariaCoin Masternode Setup Guide (Ubuntu 18.04)
This guide will assist you in setting up a Maria Masternode on a Linux Server running Ubuntu 18.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/WPV8KKX)
***
## Requirements
1) **100,000 Maria.**
...
`wget -q https://raw.githubusercontent.com/hostmaria/masternode-installer/master/ubuntu-18.04-5.5.1-mn-install`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash ubuntu-18.04-5.5.1-mn-install.sh`
...
***Step 1***
* Download and install the Maria wallet [here](https://github.com/hostmaria/mariacoin/releases)
***

***Step 2***
* Send EXACLY 100,000 NBLA to a receive address within your wallet.
***
